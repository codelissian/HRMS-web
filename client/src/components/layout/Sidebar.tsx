...
const baseNavigation = [
  ...
  { name: 'Shifts', href: 'shifts', icon: Clock, section: 'Employee Management', roles: ['admin', 'hr_manager'] },
              ...
              { name: 'Leave Management', href: 'leave-types', icon: Settings, section: 'Attendance & Leave', roles: ['admin', 'hr_manager'] },
              { name: 'Leave Requests', href: 'leaves', icon: Calendar, section: 'Attendance & Leave' },
